...
CREATE TABLE `evidence_chunks` (
	...
	`created_at` integer NOT NULL,
	FOREIGN KEY (`bundle_id`) REFERENCES `evidence_bundles`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`source_id`) REFERENCES `evidence_sources`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`video_clip_id`) REFERENCES `evidence_video_clips`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
...
CREATE TABLE `tactic_card_citations` (
	...
	FOREIGN KEY (`chunk_id`) REFERENCES `evidence_chunks`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
...
CREATE TABLE `tactic_cards` (
	...
	`updated_at` integer NOT NULL,
	FOREIGN KEY (`bundle_id`) REFERENCES `evidence_bundles`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`job_id`) REFERENCES `evidence_analysis_jobs`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
CREATE INDEX `idx_tactic_cards_bundle_status` ON `tactic_cards` (`bundle_id`,`status`);