...
type Action = { action: "pass" | "dribble" | "move"; reason: string; citationIds: string[] };
type CardContent = { situation: string; conditions: string[]; defenseType: string; cues: string[]; preferred: Action[]; alternatives: Action[]; risky: Action[]; confidence: string; uncertainties: string[]; conflicts: string[]; scenarioSuitable: boolean; animationSuitable: boolean };
